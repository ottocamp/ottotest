...
/**
 * Servlet implementation class salesYearServlet
 */
@WebServlet("/salesYear.sy")
public class salesYearServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public salesYearServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/sales/salesYearView.jsp").forward(request, response);
	}
