...
/**
 * Servlet implementation class salesDayList
 */
@WebServlet("/salesDay.sd")
public class salesDayServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public salesDayServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/sales/salesDayView.jsp").forward(request, response);
