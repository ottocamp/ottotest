									...
									<li class="list-group notification-list" style="height: 267px;">
										<div class="slimScrollDiv"
											...
											<div class="slimScrollBar"
												style="background: rgb(158, 165, 171); width: 5px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px;"></div>
				...
				<div class="scrollbar-wrapper">
					<div>
						...
						<ul class="metisMenu nav" id="side-menu">
							<li><a
								href="<%= request.getContextPath() %>/views/user/userMain.jsp"><i
									class="ti-home"></i> 회원 메인 메뉴 </a></li>

							<li><a
								href="<%= request.getContextPath() %>/views/user/userUpdate.jsp">
									<i class="ti-paint-bucket"></i> 개인 정보 수정
							</a></li>

							<li><a
								href="<%= request.getContextPath() %>/views/user/userUsed.jsp"><i
									class="ti-paint-bucket"></i> 이용내역</a></li>
							...
							<li><a href="javascript: void(0);" aria-expanded="true"><i
									class="ti-pencil-alt"></i> 리뷰 및 메모</a></li>
